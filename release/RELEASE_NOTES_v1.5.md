...
- Build-Verzeichnis: dist/ICDL-Ergebnisse-v1.5/
- EXE: dist/ICDL-Ergebnisse-v1.5/ICDL-Ergebnisse.exe
- Dokumentation: dist/<Build>/docs/
- Archivdaten: dist/ICDL-Ergebnisse-v1.5/archive/
- Release-ZIP: release/ICDL-Ergebnisse-v1.5.zip

## Enthaltene Commits (aktuelle Historie)

- *(Commitliste konnte automatisch nicht ermittelt werden.)*

## Technische Build-Informationen

- Build-Datum: 2026-07-04 15:22:58
